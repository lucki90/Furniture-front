...
/**
 * Validator dla szafki wiszącej otwartej — bez drzwi (UPPER_OPEN_SHELF).
 */
export class UpperOpenShelfCabinetValidator implements KitchenCabinetValidator {

  private readonly constraints = KitchenCabinetConstraints.UPPER_OPEN_SHELF;
